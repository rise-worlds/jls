...
server_uid = os.environ.get('NAME', 'crack').lower()
...
if not os.path.exists('plugins.json'):
    copy2(Path(os.path.abspath(__file__)).parent.joinpath('plugins.json'), '.')
if not os.path.exists('licenses_base.json'):
    copy2(Path(os.path.abspath(__file__)).parent.joinpath('licenses_base.json'), '.')
